...
export function ConversationQueueCard({
    ...
    return (
        <div className="w-full max-w-full box-border bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-3 hover:shadow-md transition-shadow overflow-hidden relative border-l-4" style={{ borderLeftColor: 'transparent' }}>
            {/* Status color border */}
