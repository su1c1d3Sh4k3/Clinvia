        ...
        <div className="space-y-8">
            ...
            <TopicSection id="tags" index={7} icon={Tag} title="Tags (etiquetas)"
                ...
                <StepByStep steps={[
                    ...
                    { title: "Tags de campanha são automáticas", description: "Cada campanha disparada etiqueta os contatos com o nome da campanha. É assim que o sistema te avisa se você tentar disparar de novo para quem já recebeu há menos de 7 dias." },
                ]} />
            </TopicSection>
