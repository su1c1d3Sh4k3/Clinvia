        ...
        <div className="space-y-8">
            ...
            <TopicSection id="sandbox" index={10} icon={FlaskConical} title="Ambiente de teste da IA"
                ...
                <StepByStep steps={[
                    ...
                    { title: "Tom de voz do teste", description: "Abaixo da conversa, fechado — clique no título para abrir. São os mesmos controles da aba Tom de voz, só que em rascunho. Salvar no teste faz a PRÓXIMA mensagem do chat já sair no tom novo, sem mexer no atendimento real. Quando gostar do resultado, Salvar em produção publica para valer. O campo Sobre a clínica não fica aqui: ele é único e se edita na aba Tom de voz." },
                    { title: "Simuladores", description: "O último bloco, também fechado por padrão. Aqui você provoca as situações que normalmente dependem de esperar: uma campanha chegando, uma mensagem de recorrência, uma confirmação de agendamento, uma venda avulsa ou um convênio no cadastro do paciente. A IA recebe exatamente como receberia na vida real." },
                ]} />
