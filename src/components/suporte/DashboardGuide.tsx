    ...
    return (
        <div className="space-y-8">
            ...
            <TopicSection id="minha-conta" index={9} icon={Wallet} title="Aba Minha Conta"
                ...
                <StepByStep steps={[
                    { title: "Consumo de Tokens da IA", description: "Cards de Total, Consumo Mensal e Consumo Diário (custo em R$ em destaque e a quantidade de tokens logo abaixo, somando a IA das conversas e a do sistema; a conversão usa a cotação real do dólar). O quarto card, Envios Meta, estima o gasto com envio de templates do WhatsApp Oficial (nº de mensagens × preço por categoria do template — marketing, utility ou autenticação — convertido em R$), com os recortes do mês e do dia. Abaixo, os gráficos de consumo mensal (com filtro de ano) e diário (7, 15 ou 30 dias)." },
