        ...
        <div className="space-y-8">
            ...
            <TopicSection id="calendario" index={2} icon={MousePointerClick} title="Navegando no calendário"
                ...
                <StepByStep steps={[
                    ...
                    { title: "Leia a grade", description: "Cada coluna é um profissional; a área cinza é fora do horário dele. As linhas acompanham o Tamanho do slot configurado em IA > Configurações e a coluna da esquerda continua marcando as horas cheias. Quando uma faixa tem atendimentos curtos — procedimentos de 5 ou 10 minutos, por exemplo — aquela hora se dilata sozinha para que nenhum card fique espremido: as 8:00 podem ficar três vezes mais altas enquanto o resto do dia continua no tamanho de sempre. Passe o mouse sobre um evento para ver o card completo (serviço, sala, horário, status e quem agendou) com os botões de status — ele aparece sempre por cima de tudo, mesmo quando o agendamento está no pé da tela." },
                    { title: "Dois agendamentos no mesmo horário", description: "Quando dois eventos ocupam o mesmo espaço — por exemplo um cancelado e o novo agendamento remarcado para a mesma hora — eles se dividem lado a lado na coluna, cada um com metade da largura, para que nenhum fique escondido atrás do outro." },
                    { title: "Visão solo", description: "Clique no nome do profissional no cabeçalho para ver só a agenda dele; a seta restaura a visão geral. Na agenda única a grade fica com o dobro da altura (slots curtos deixam de ser uma tirinha), a coluna da esquerda passa a marcar de slot em slot (8:00, 8:10, 8:20...) e cada card mostra o nome do cliente em negrito com horário, serviço, data em que foi agendado e quem agendou logo abaixo." },
                    { title: "Lista de profissionais", description: "Na barra lateral, logo abaixo do calendário, há um botão para cada agenda do modo atual, sempre em ordem alfabética — a mesma ordem das colunas da grade. Clique e a grade mostra só aquela agenda; o botão Todos volta à visão geral. Ideal para clínicas com muitos profissionais — a escolha continua valendo quando você troca de dia." },
