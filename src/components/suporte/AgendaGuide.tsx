        ...
        <div className="space-y-8">
            ...
            <TopicSection id="calendario" index={2} icon={MousePointerClick} title="Navegando no calendário"
                ...
                <StepByStep steps={[
                    ...
                    { title: "Leia a grade", description: "Cada coluna é um profissional; a área cinza é fora do horário dele. Passe o mouse sobre um evento para ver o card completo (serviço, sala, horário, status e quem agendou) com os botões de status — ele aparece sempre por cima de tudo, mesmo quando o agendamento está no pé da tela." },
