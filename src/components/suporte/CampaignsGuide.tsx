            ...
            <TopicSection id="resultados" index={6} icon={BarChart3} title="Acompanhando resultados"
                ...
                <div className="space-y-2">
                    ...
                    <div className="grid gap-2 lg:grid-cols-2">
                        ...
                        <LegendRow badge="Atendente (nome ou IA)" cls="bg-violet-100 text-violet-700 dark:bg-violet-900/50 dark:text-violet-300" text="Quem cuidou do contato: a IA ou o membro da equipe que assumiu a conversa. Só existe para quem recebeu a mensagem." />
                    </div>
                </div>
                <div className="space-y-2">
