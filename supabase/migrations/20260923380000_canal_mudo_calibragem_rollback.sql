-- Rollback de 20260923380000_canal_mudo_calibragem.sql
--
-- CONSEQUENCIA DE RODAR ISTO: uma unica recusa da Meta volta a declarar o canal
-- MUDO mesmo que outras mensagens tenham saido no mesmo minuto. Na pratica, um
-- destinatario com numero errado passa a gerar incidente critico e e-mail a cada
-- cooldown — e o vigia perde a credibilidade que e a unica coisa que ele tem.
--
-- So faz sentido rodar isto se aparecer um caso em que a recusa PARCIAL for, de
-- fato, sinal de canal caindo (por exemplo, a Meta comecar a recusar por
-- qualidade em ordem aleatoria de destinatario). Nesse caso, o certo e mudar o
-- criterio — nao voltar ao antigo.
--
-- Este arquivo recria a versao anterior da funcao, identica a que veio em
-- 20260923370000, mudando apenas o bloco (a).
