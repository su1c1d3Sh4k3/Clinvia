...
BEGIN
    ...
    -- contact_id/conversation_id: o painel abre o chat daquele atendimento para
    -- o usuário entender o contexto da nota (conversation_id só vem preenchido
    -- quando a conversa citada na entrada de NPS ainda existe).
