...
export const SUPPORT_TOPICS: SupportTopic[] = [
    ...
    },
    {
        ...
        gotchas: [
            ...
            "As linhas da grade seguem o Tamanho do slot de IA > Configuracoes: mudar o slot muda a divisao desenhada na agenda. Na grade com varias salas a coluna da esquerda continua marcando so as horas cheias (8:00, 9:00...). Com slot menor que 15 minutos a divisao NAO encolhe — ela mantem a altura minima de leitura e quem cresce e a HORA, entao a distancia entre 8:00 e 9:00 aumenta e a pagina rola mais. De 15 minutos para cima a grade fica no tamanho de sempre.",
