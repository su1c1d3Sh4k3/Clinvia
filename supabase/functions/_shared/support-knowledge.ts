...
export const SUPPORT_TOPICS: SupportTopic[] = [
    {
        ...
        gotchas: [
            ...
            "O custo de IA tambem e uma ESTIMATIVA. A cada resposta a IA reenvia a conversa inteira, e o provedor cobra essa parte repetida mais barato (cache). O sistema ja aplica esse desconto, mas so a fatura do provedor e o valor oficial.",
