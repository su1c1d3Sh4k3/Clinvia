...
export const SUPPORT_TOPICS: SupportTopic[] = [
    ...
    },
    {
        ...
        resolves: [
            ...
            "o que e o container 'Contemplados pelo Convenio'",
        ],
        steps: [
            ...
            "O container 'Contemplados pelo Convenio', abaixo das categorias, abre em convenio > servico > procedimentos e mostra as MESMAS aplicacoes, so que reagrupadas.",
        ],
        gotchas: [
            "O preco cadastrado no servico e a fonte unica: valor digitado em planilha de importacao nao altera o cadastro.",
            "A coluna 'Valor convenio' (ao lado de Valor) e o container 'Contemplados pelo Convenio' so aparecem quando existe pelo menos um servico marcado em algum convenio (Equipe > Convenios > Configurar).",
            ...
            "Dentro do container do convenio nao da para criar nem excluir aplicacao (so editar e ligar/desligar): a aplicacao mora na categoria de origem.",
    ...
    },
    {
        ...
        steps: [
            ...
            "Convenios: cadastre o plano (nome e descricao opcional), marque os servicos atendidos por categoria e marque as salas que recebem esse plano. Se a clinica aceita qualquer plano, ligue a chave 'Habilitar todos os convenios' no topo da aba.",
        ...
        gotchas: [
            ...
            "Marcar o servico no convenio libera, na pagina Servicos, a coluna 'Valor convenio' e o container 'Contemplados pelo Convenio'. O valor cobrado no plano e definido no lapis da aplicacao (campo 'Valor de Convenio (R$)'), e um so para todos os planos, e em branco acompanha o valor de venda.",
        ],
    },
    {
        id: "agenda",
