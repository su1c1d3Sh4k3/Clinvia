...
export const SUPPORT_TOPICS: SupportTopic[] = [
    ...
    },
    {
        ...
        resolves: [
            ...
            "como colocar uma imagem fixa no template (cabecalho com foto)",
        ...
        steps: [
            ...
            "Para criar um template com imagem: aba Templates > Novo template > campo Cabecalho > opcao Imagem > escolha um JPG ou PNG de ate 5 MB.",
        ],
        gotchas: [
            ...
            "A imagem do cabecalho e FIXA por template: a mesma foto vai em todos os envios (chat, nova mensagem e campanhas) e nao da para escolher outra na hora do disparo. Para trocar, edite o template e envie o novo arquivo — ele volta para revisao da Meta.",
            "Template com cabecalho de imagem que esta sem arquivo salvo (por exemplo, criado direto no painel da Meta e trazido pelo Sincronizar) nao aparece na lista de campanhas e mostra aviso ambar na aba Templates: edite o template e escolha a imagem para liberar o envio.",
