...
export const SUPPORT_TOPICS: SupportTopic[] = [
    ...
    },
    {
        ...
        steps: [
            "Abra Equipe no menu lateral (aba Equipes).",
            "Clique em adicionar membro, informe nome, e-mail, senha e cargo.",
            "No mesmo modal defina o escopo do Atendente: conexoes, filas e tags visiveis.",
    ...
    },
    {
        ...
        resolves: [
            ...
            "como configurar o horario de trabalho do profissional",
        ...
        steps: [
            ...
            "Clique num horario livre para abrir o agendamento: cliente, servico, profissional e forma de pagamento.",
            "O horario de trabalho de cada profissional fica no cadastro dele, com opcao de horario diferente por dia da semana.",
        ],
        gotchas: [
