...
export const SUPPORT_TOPICS: SupportTopic[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            "Ambiente de teste: em IA > Configuracoes clique em 'Testar IA no ambiente Sandbox'. No topo, preso na tela enquanto se rola a pagina, fica o custo do teste; logo abaixo o chat (escreva como o paciente falaria) com o seletor 'Agenda Real' ou 'Agenda Liberada' e o botao 'Limpar memoria'; ao lado o paciente ficticio editavel, 'O que a IA fez', o CRM e os agendamentos/vendas; depois do chat vem 'Tom de voz do teste' e, por ultimo, os simuladores de campanha, recorrencia, confirmacao de agendamento, venda e convenio. Esses DOIS ultimos blocos comecam FECHADOS: e preciso clicar no titulo para abrir. Terminou, clique em 'Resetar ambiente'.",
            "No 'Tom de voz do teste' (dentro do Sandbox) os controles ficam em tres colunas: Proximidade/Elaboracao/Assertividade, Abordagem/Formalidade/Expressividade e Tecnicidade/Tratamento/Emoji. O campo 'Sobre a clinica' NAO fica ali: ele e unico e se edita em IA > Tom de voz — o valor salvo la e usado tambem no teste.",
        ],
        gotchas: [
